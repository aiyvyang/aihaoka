<template>
  ...
  <div class="mainnavi top" v-if="type === 'top'">
    <ul class="ul">
      ...
      <li
        ...
        :class="{ on: (page.relativePath == 'pages/archives.md' && selected === '') || selected === 'archives' }"
      >
  ...
  <div class="mainnavi left" v-else>
    ...
    <ul class="ul">
      ...
      >
        <a class="a" :href="withBase(`/pages/feed`)">
          <svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
      ...
      <li
        class="li"
        @click="choose('tools')"
        :class="{ on: (page.relativePath == 'pages/tools.md' && selected === '') || selected === 'tools' }"
      >
        <a class="a" :href="withBase(`/pages/tools`)">
          <svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
      ...
      <li
        class="li"
        @click="choose('about')"
        :class="{ on: (page.relativePath == 'pages/about.md' && selected === '') || selected === 'about' }"
      >
        <a class="a" :href="withBase(`/pages/about`)">
          <svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
...
onMounted(() => {
  ...
  params.value = new URLSearchParams(url.value)

  // 如果需要根据URL参数设置初始选中状态
  const initialSelected = params.value.get('category') // 假设参数名是category
  if (initialSelected) {
