  ...
  <div class="articlelink">
      ...
      <span class="span"
        ><svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path
            ...
            fill="currentColor"
          ></path></svg
        >{{ work?.title ? work.title : '资源信息' }}</span
      >
    </div>
    <div class="view" v-if="work?.view && !work?.qrcode">
      <a class="a vp-external-link-icon" :href="work?.view" target="_blank"
        ><span>{{ work.viewtit ? work.viewtit : '官网 / 效果' }}</span></a
      >
    </div>
    <VDropdown placement="top" :distance="10" v-if="work?.view && work?.qrcode">
      <div class="view" v-tooltip="''" v-if="work?.view">
        <button class="a">
          <span>{{ work.viewtit ? work.viewtit : '预览效果' }}</span>
          <svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
    ...
    <div class="entry" v-if="work?.github">
      ...
      <div class="githubcard" v-if="entrystart">
        <ul class="ul">
          <li class="li" v-if="entry?.stargazers_count !== 0">
            <svg
              class="svg"
              aria-hidden="true"
              height="16"
          ...
          <li class="li" v-if="entry?.open_issues_count !== 0">
            <svg
              class="svg"
              aria-hidden="true"
              height="16"
          ...
          <li class="li" v-if="entry?.forks_count !== 0">
            <svg
              class="svg"
              aria-label="fork"
              role="img"
          ...
          <li class="li" v-if="entry?.license">
            <svg
              class="svg"
              aria-hidden="true"
              height="16"
          ...
          <li class="li" v-if="entry?.updated_at">
            <svg
              class="svg"
              aria-hidden="true"
              focusable="false"
            ...
            Updated_at : {{ relativeTime(entry?.updated_at) }}
          </li>
        </ul>
      </div>
    </div>
